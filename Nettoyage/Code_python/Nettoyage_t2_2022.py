...
fichier_source = "C:/Users/Massi/Desktop/MSPR BLOC 03/DATA_Set_brut/2022_tour2.xlsx"
feuille = "commune"
...
#      "% Voix/Exp Élu"
# ]
# === Ajouter colonne Position Politique (catégorie)
def position_politique(parti):
    if pd.isna(parti):
        return None
    ...
    return mapping_position.get(parti, "Inconnu")

# Appliquer la fonction à la colonne Parti Politique Élu
df["Position Politique"] = df["Parti Politique Élu"].apply(position_politique)

# Ajouter la nouvelle colonne à la liste des colonnes à conserver
colonnes_a_conserver = [
    "ID Commune", "Abstentions", "Inscrits", "Taux Abstention (%)",
    "Sexe Élu", "Nom Complet Élu","% Voix/Exp Élu","Parti Politique Élu", "Orientation Politique",
    "Position Politique"
]
...
# Sauvegarde
df_nom_fichier = "DATA_Nettoyer_t2_2022.xlsx"
