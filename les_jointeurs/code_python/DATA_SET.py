...
if jointures:
    ...
    fichier_excel_final = os.path.join(dossier_sortie, "Dataset_Finale_MSPR_2025.xlsx")
    fichier_csv_final = os.path.join(dossier_sortie, "Dataset_Finale_MSPR_2025.csv")
